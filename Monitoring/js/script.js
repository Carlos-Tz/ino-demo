...
obtenerDispositivos()
    .then(dispositivos => {
        ...
        if (dispositivosDeVideo.length > 0) {
           ...
           divic= dispositivosDeVideo[1].deviceId;
        }
    });
...
// https://stackoverflow.com/questions/783818/how-do-i-create-a-custom-error-in-javascript
    ...
    var construct= { video: { facingMode: { exact: "environment" } } }
    ...
    var Webcam = {
        ...
        params: {
            ...
            constraints:  { facingMode: { exact: "environment" } } ,  // custom user media constraints,
